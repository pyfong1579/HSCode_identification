...
# Extract large or medium classification among 6 digits
...
# Word2vec To put it in the right shape
...
max_sentence_length= 38   # The maximum length of the sentence is 50
...
# word {Key:Value} Dictionary Processing and processing for when an existing word is entered
